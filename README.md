# v-movable [![npm version](https://badge.fury.io/js/v-movable.svg)](https://badge.fury.io/js/v-movable) [![tests](https://img.shields.io/github/actions/workflow/status/thewebkid/v-movable/test.yml?branch=master&label=tests)](https://github.com/thewebkid/v-movable/actions/workflows/test.yml) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
